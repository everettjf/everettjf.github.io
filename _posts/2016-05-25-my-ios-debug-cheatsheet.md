...
title_zh: "iOS 调试速查表（iOS Debug Cheatsheet）"
lang_original: zh
categories: Skill
comments: true
---
...
During reverse engineering there are too many commands to remember, so I put together this cheatsheet to share with everyone. I've only finished reading the "little yellow book" *iOS App Reverse Engineering*, and I haven't dug deeper into reverse engineering these past few months. Recently I wanted to reverse a few apps to learn how they're implemented, and found I'd forgotten many commands. So I put together this table. Copy and paste, and you can happily study how other apps are built.

The commands are all pretty basic, simple, and commonly used — mainly because that's all I've learned, haha.
...
lldb connecting to remote debug
...
Print the sandbox Documents path
...
PS: [This article was first published on iosre.com](http://iosre.com/t/debug/3778)
