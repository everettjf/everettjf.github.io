...
![XSourceNote](/stuff/xsourcenote/project_whole.png)
...
For example:
 ...
 ![XSourceNote](/stuff/xsourcenote/project_basic.png)
...
You can enter the note in this window. (It's saved automatically when closed.) After adding, a green marker is added in the left sidebar of the corresponding line in the editor.
 ...
 ![XSourceNote](/stuff/xsourcenote/quick_note.png)


 ![XSourceNote](/stuff/xsourcenote/sidebar.png)
...
Still the window opened with Shift+F4: on the left, the notes for code lines are appended below the list.
 ...
 ![XSourceNote](/stuff/xsourcenote/line_note.png)
...
For format reference: [format reference](/2016/03/17/yycache-learn)
...
格式参考：[格式参考](/2016/03/17/yycache-learn)
