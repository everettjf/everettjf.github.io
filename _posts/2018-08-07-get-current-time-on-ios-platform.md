---
layout: post
title: "Several Ways to Get the Current Time on the iOS Platform"
title_zh: "iOS 平台获取当前时间的几种方法"
lang_original: zh
categories:
  - guide
tags:
...
A collection of various methods related to getting the time.
...
To measure time cost, you can generally use `CACurrentMediaTime()`, which avoids the error introduced by small system clock adjustments (for example, during app launch the system automatically fine-tunes and syncs the time, gaining or losing a few seconds).
